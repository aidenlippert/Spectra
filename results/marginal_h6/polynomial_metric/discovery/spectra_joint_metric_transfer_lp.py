...
root=Path('/Users/aidenlippert/Documents/Spectra/results/marginal_h6/polynomial_metric/joint_metric_transfer');out=root/'nonsingleton_quotient_dual';out.mkdir(exist_ok=True)
