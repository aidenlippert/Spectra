...
root=Path('/Users/aidenlippert/Documents/Spectra/results/marginal_h6/polynomial_metric');out=root/'joint_metric_proof';out.mkdir(exist_ok=True);proposal=json.loads((root/'joint_metric_cone/proposal_-6.24.json').read_text());c=json.loads((root/'candidate.json').read_text());metric_den=10**9;proof_den=10**12
