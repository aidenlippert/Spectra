...
def campaign(output, map_proposal, primitive_proposal):
    ...
    development = read(baseline_root / "nonenumerating_reference001/fresh_input/specification.json")
    transfer = read(baseline_root / "physical_transfer_h6001/fresh_input/specification.json")
