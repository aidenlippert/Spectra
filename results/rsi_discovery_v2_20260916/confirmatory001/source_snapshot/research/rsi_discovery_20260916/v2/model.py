...
SCHEMA = {"type": "object", "additionalProperties": False, "properties": {
    "hypothesis": {"type": "string"}, "mechanism": {"type": "string"},
    "source": {"type": "string"}, "assumptions": {"type": "string"},
...
Write executable pure Python with entry point propose(payload). Helper functions are permitted.
