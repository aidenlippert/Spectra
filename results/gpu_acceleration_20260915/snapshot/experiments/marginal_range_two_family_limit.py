...
def replay(c):
    ...
    full_signed = c['kind'] in ('joint_diagonal_range2_family_limit_v6', 'joint_diagonal_range2_family_limit_v7', 'joint_diagonal_range2_family_limit_v8', 'joint_diagonal_range2_family_limit_v9', 'joint_diagonal_range2_family_limit_v10', 'joint_diagonal_range2_family_limit_v11', 'joint_diagonal_range2_family_limit_v12', 'joint_diagonal_range2_family_limit_v13', 'joint_diagonal_range2_family_limit_v14','joint_diagonal_range2_family_limit_v15','joint_diagonal_range2_family_limit_v16')
    coherent = c['kind'] in ('joint_diagonal_range2_family_limit_v7', 'joint_diagonal_range2_family_limit_v8', 'joint_diagonal_range2_family_limit_v9', 'joint_diagonal_range2_family_limit_v10', 'joint_diagonal_range2_family_limit_v11', 'joint_diagonal_range2_family_limit_v12', 'joint_diagonal_range2_family_limit_v13', 'joint_diagonal_range2_family_limit_v14','joint_diagonal_range2_family_limit_v15','joint_diagonal_range2_family_limit_v16')
    spin = c['kind'] in ('joint_diagonal_range2_family_limit_v8', 'joint_diagonal_range2_family_limit_v9', 'joint_diagonal_range2_family_limit_v10', 'joint_diagonal_range2_family_limit_v11', 'joint_diagonal_range2_family_limit_v12', 'joint_diagonal_range2_family_limit_v13', 'joint_diagonal_range2_family_limit_v14','joint_diagonal_range2_family_limit_v15','joint_diagonal_range2_family_limit_v16')
    residual_coherence = c['kind'] == 'joint_diagonal_range2_family_limit_v16'
    pure_coherence = residual_coherence or c['kind'] == 'joint_diagonal_range2_family_limit_v15'
    full_spin_word = pure_coherence or c['kind'] == 'joint_diagonal_range2_family_limit_v14'
    coherent_projector = full_spin_word or c['kind'] == 'joint_diagonal_range2_family_limit_v13'
    three_spectator = coherent_projector or c['kind'] == 'joint_diagonal_range2_family_limit_v12'
    ...
    base = replay_constraints(nearest, free_range_two_profile=free_profile, full_quadratic_charge=full_quadratic, charge_square_pairs=square_pairs, full_charge_indicators=full_indicators, full_signed_charge=full_signed, hopping_telescope=coherent, spin_telescope=spin, spectator_hopping=spectator, pair_transfer=pair_transfer, two_spectator_hopping=two_spectator, three_spectator_hopping=three_spectator, coherent_projector=coherent_projector, full_spin_word=full_spin_word, pure_coherence=pure_coherence, residual_coherence=residual_coherence)
    ...
    if coherent_projector:
        result['coherent_projector_moments']=base['coherent_projector_moments']
        result['scope']+=' Both fixed coherent-projector overlap telescopes are covered by exact zero moments.'
    if full_spin_word:
        result['spin_word_moments']=base['spin_word_moments']
        result['scope']+=' All120 PH/spin-even reflection-odd diagonal spin-word directions have exact zero moments.'
    if residual_coherence:
        result['residual_coherence_moments']=base['residual_coherence_moments']
    if pure_coherence:
        result['pure_coherence_moments']=base['pure_coherence_moments']
        result['scope']+=' Both pure-coherence telescopes have exact zero moments.'
    return result
