...
def replay(certificate,*,psd_witnesses=None):
    if type(certificate) is dict and 'pure_coherence' in certificate and certificate.get('kind') != 'hubbard_projector_extension_v19':
        raise ValueError('Pure coherence requires v19')
    if type(certificate) is dict and 'spin_word_telescope' in certificate and certificate.get('kind') not in ('hubbard_projector_extension_v18','hubbard_projector_extension_v19'):
        raise ValueError('Full spin-word telescope requires v18')
    if type(certificate) is dict and 'coherent_projector' in certificate and certificate.get('kind') not in ('hubbard_projector_extension_v17','hubbard_projector_extension_v18','hubbard_projector_extension_v19'):
        raise ValueError('Coherent-projector telescope requires v17')
    if type(certificate) is dict and 'three_spectator_hopping' in certificate and certificate.get('kind') not in ('hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18','hubbard_projector_extension_v19'):
        raise ValueError('Three-spectator hopping requires v16')
    if type(certificate) is dict and 'two_spectator_hopping' in certificate and certificate.get('kind') not in ('hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18','hubbard_projector_extension_v19'):
        raise ValueError('Two-spectator hopping requires v15')
    if type(certificate) is dict and 'pair_transfer' in certificate and certificate.get('kind') not in ('hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18','hubbard_projector_extension_v19'):
...
def _replay_extended(c,proof=None):
    ...
    spin=c.get('kind') in ('hubbard_projector_extension_v12','hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18','hubbard_projector_extension_v19')
    pure_coherence=c.get('kind')=='hubbard_projector_extension_v19'
    ...
    full_spin_word=c.get('kind') in ('hubbard_projector_extension_v18','hubbard_projector_extension_v19')
    ...
    coherent_projector=c.get('kind') in ('hubbard_projector_extension_v17','hubbard_projector_extension_v18','hubbard_projector_extension_v19')
    ...
    three_spectator=c.get('kind') in ('hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18','hubbard_projector_extension_v19')
    ...
    two_spectator=c.get('kind') in ('hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18','hubbard_projector_extension_v19')
    ...
    pair_transfer=c.get('kind') in ('hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18','hubbard_projector_extension_v19')
    ...
    spectator=c.get('kind') in ('hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18','hubbard_projector_extension_v19')
