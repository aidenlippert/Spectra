...
def _replay(c, *, free_range_two_profile, full_quadratic_charge=False, charge_square_pairs=False, full_charge_indicators=False, full_signed_charge=False, hopping_telescope=False, spin_telescope=False, spectator_hopping=False, pair_transfer=False, two_spectator_hopping=False):
    ...
    if 'quadratic_charge_telescope' in c or 'charge_square_pair_telescope' in c or 'higher_charge_indicator_telescope' in c or 'signed_charge_telescope' in c or 'hopping_telescope' in c or 'spin_telescope' in c or 'spectator_hopping' in c or 'pair_transfer' in c or 'two_spectator_hopping' in c:
