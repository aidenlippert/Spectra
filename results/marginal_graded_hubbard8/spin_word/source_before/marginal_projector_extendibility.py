...
def replay(certificate,*,psd_witnesses=None):
    if type(certificate) is dict and 'coherent_projector' in certificate and certificate.get('kind') != 'hubbard_projector_extension_v17':
        raise ValueError('Coherent-projector telescope requires v17')
    if type(certificate) is dict and 'three_spectator_hopping' in certificate and certificate.get('kind') not in ('hubbard_projector_extension_v16','hubbard_projector_extension_v17'):
        raise ValueError('Three-spectator hopping requires v16')
    if type(certificate) is dict and 'two_spectator_hopping' in certificate and certificate.get('kind') not in ('hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17'):
        raise ValueError('Two-spectator hopping requires v15')
    if type(certificate) is dict and 'pair_transfer' in certificate and certificate.get('kind') not in ('hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17'):
...
def _replay_extended(c,proof=None):
    ...
    full_signed=c.get('kind') in ('hubbard_projector_extension_v10','hubbard_projector_extension_v11','hubbard_projector_extension_v12','hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17')
    coherent=c.get('kind') in ('hubbard_projector_extension_v11','hubbard_projector_extension_v12','hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17')
    spin=c.get('kind') in ('hubbard_projector_extension_v12','hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17')
    coherent_projector=c.get('kind')=='hubbard_projector_extension_v17'
    ...
    three_spectator=c.get('kind') in ('hubbard_projector_extension_v16','hubbard_projector_extension_v17')
    ...
    two_spectator=c.get('kind') in ('hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17')
    ...
    pair_transfer=c.get('kind') in ('hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17')
    ...
    spectator=c.get('kind') in ('hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17')
    ...
    for key,(_,matrix,columns) in data.items():
        ...
        corrections=[]
        for col in columns:
            values={telescope.get(s&1023,F(0))-telescope.get(s>>2,F(0)) + (diagonal_value(s,range_profile) if range_two else 0) + (local_value(s,quadratic_terms) if quadratic else 0) + (square_value(s,square_terms) if square_pairs else 0) + (indicator_value(s,indicator_terms) if full_indicators else 0) + (signed_value(s,signed_terms) if full_signed else 0) for s in col}
