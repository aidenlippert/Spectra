...
def _replay_extended(c,proof=None):
    ...
    full_indicators=c.get('kind') in ('hubbard_projector_extension_v9','hubbard_projector_extension_v10','hubbard_projector_extension_v11','hubbard_projector_extension_v12','hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16')
    full_signed=c.get('kind') in ('hubbard_projector_extension_v10','hubbard_projector_extension_v11','hubbard_projector_extension_v12','hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16')
    coherent=c.get('kind') in ('hubbard_projector_extension_v11','hubbard_projector_extension_v12','hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16')
    spin=c.get('kind') in ('hubbard_projector_extension_v12','hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16')
    three_spectator=c.get('kind')=='hubbard_projector_extension_v16'
    ...
    two_spectator=c.get('kind') in ('hubbard_projector_extension_v15','hubbard_projector_extension_v16')
    ...
    pair_transfer=c.get('kind') in ('hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16')
    ...
    spectator=c.get('kind') in ('hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16')
