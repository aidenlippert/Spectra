...
def _replay(c, *, free_range_two_profile, full_quadratic_charge=False, charge_square_pairs=False, full_charge_indicators=False, full_signed_charge=False, hopping_telescope=False, spin_telescope=False, spectator_hopping=False, pair_transfer=False, two_spectator_hopping=False, three_spectator_hopping=False):
