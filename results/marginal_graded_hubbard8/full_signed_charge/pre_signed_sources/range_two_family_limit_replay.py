...
def main():
    ...
    full_indicators=source['kind']=='joint_diagonal_full_charge_indicator_family_proposal_v1'
    ...
    receipt = {'accepted': True, 'free_range_two_profile':free_profile, 'full_quadratic_charge':full_quadratic, 'charge_square_pairs':square_pairs, 'full_charge_indicators':full_indicators, 'family_replay': result, 'accepted_periodic_lower': str(lower),
