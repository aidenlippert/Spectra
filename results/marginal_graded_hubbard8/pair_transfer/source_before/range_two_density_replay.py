...
def main():
    ...
    if c.get('kind') not in ('hubbard_projector_extension_v6','hubbard_projector_extension_v7','hubbard_projector_extension_v8','hubbard_projector_extension_v9','hubbard_projector_extension_v10','hubbard_projector_extension_v11','hubbard_projector_extension_v12','hubbard_projector_extension_v13'):
