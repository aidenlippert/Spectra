...
def replay(certificate,*,psd_witnesses=None):
    if type(certificate) is dict and 'spin_word_telescope' in certificate and certificate.get('kind') != 'hubbard_projector_extension_v18':
        raise ValueError('Full spin-word telescope requires v18')
    if type(certificate) is dict and 'coherent_projector' in certificate and certificate.get('kind') not in ('hubbard_projector_extension_v17','hubbard_projector_extension_v18'):
        raise ValueError('Coherent-projector telescope requires v17')
    if type(certificate) is dict and 'three_spectator_hopping' in certificate and certificate.get('kind') not in ('hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18'):
        raise ValueError('Three-spectator hopping requires v16')
    if type(certificate) is dict and 'two_spectator_hopping' in certificate and certificate.get('kind') not in ('hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18'):
        raise ValueError('Two-spectator hopping requires v15')
    if type(certificate) is dict and 'pair_transfer' in certificate and certificate.get('kind') not in ('hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18'):
        raise ValueError('Pair transfer requires v14')
    if type(certificate) is dict and certificate.get('kind') in ('hubbard_projector_extension_v2','hubbard_projector_extension_v4','hubbard_projector_extension_v5','hubbard_projector_extension_v6','hubbard_projector_extension_v7','hubbard_projector_extension_v8','hubbard_projector_extension_v9','hubbard_projector_extension_v10','hubbard_projector_extension_v11','hubbard_projector_extension_v12','hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18'):
...
def _replay_extended(c,proof=None):
    ...
    coherent=c.get('kind') in ('hubbard_projector_extension_v11','hubbard_projector_extension_v12','hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18')
    spin=c.get('kind') in ('hubbard_projector_extension_v12','hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18')
    full_spin_word=c.get('kind')=='hubbard_projector_extension_v18'
    ...
    coherent_projector=c.get('kind') in ('hubbard_projector_extension_v17','hubbard_projector_extension_v18')
    ...
    three_spectator=c.get('kind') in ('hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18')
    ...
    two_spectator=c.get('kind') in ('hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18')
    ...
    pair_transfer=c.get('kind') in ('hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18')
    ...
    spectator=c.get('kind') in ('hubbard_projector_extension_v13','hubbard_projector_extension_v14','hubbard_projector_extension_v15','hubbard_projector_extension_v16','hubbard_projector_extension_v17','hubbard_projector_extension_v18')
