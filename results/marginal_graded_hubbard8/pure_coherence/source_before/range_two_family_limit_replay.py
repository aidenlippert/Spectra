...
def main():
    ...
    full_spin_word=source['kind']=='joint_spin_word_family_proposal_v1'
    ...
    receipt = {'accepted': True, 'free_range_two_profile':free_profile, 'full_quadratic_charge':full_quadratic, 'charge_square_pairs':square_pairs, 'full_charge_indicators':full_indicators, 'full_signed_charge':full_signed, 'hopping_telescope':coherent, 'spin_telescope':spin, 'spectator_hopping':spectator, 'pair_transfer':pair_transfer, 'two_spectator_hopping':two_spectator, 'three_spectator_hopping':three_spectator, 'coherent_projector':coherent_projector, 'full_spin_word':full_spin_word, 'family_replay': result, 'accepted_periodic_lower': str(lower),
