...
def replay(c):
    ...
    spin = c['kind'] in ('joint_diagonal_range2_family_limit_v8', 'joint_diagonal_range2_family_limit_v9', 'joint_diagonal_range2_family_limit_v10', 'joint_diagonal_range2_family_limit_v11', 'joint_diagonal_range2_family_limit_v12', 'joint_diagonal_range2_family_limit_v13', 'joint_diagonal_range2_family_limit_v14')
    full_spin_word = c['kind'] == 'joint_diagonal_range2_family_limit_v14'
