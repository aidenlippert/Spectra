...
def main():
    global OUT
    parser=argparse.ArgumentParser();parser.add_argument('--directory',type=Path,default=OUT);parser.add_argument('--range-two',action='store_true');parser.add_argument('--free-range-two-profile',action='store_true');parser.add_argument('--quadratic-charge',action='store_true');parser.add_argument('--charge-square-pairs',action='store_true');parser.add_argument('--full-charge-indicators',action='store_true')
