...
def _replay_extended(c,proof=None):
    ...
    range_two=c.get('kind') in ('hubbard_projector_extension_v6','hubbard_projector_extension_v7','hubbard_projector_extension_v8','hubbard_projector_extension_v9','hubbard_projector_extension_v10','hubbard_projector_extension_v11')
    quadratic=c.get('kind') in ('hubbard_projector_extension_v7','hubbard_projector_extension_v8','hubbard_projector_extension_v9','hubbard_projector_extension_v10','hubbard_projector_extension_v11')
    square_pairs=c.get('kind') in ('hubbard_projector_extension_v8','hubbard_projector_extension_v9','hubbard_projector_extension_v10','hubbard_projector_extension_v11')
    full_indicators=c.get('kind') in ('hubbard_projector_extension_v9','hubbard_projector_extension_v10','hubbard_projector_extension_v11')
    full_signed=c.get('kind') in ('hubbard_projector_extension_v10','hubbard_projector_extension_v11')
    coherent=c.get('kind')=='hubbard_projector_extension_v11'
    ...
    joint = c.get('kind') in ('hubbard_projector_extension_v4','hubbard_projector_extension_v5','hubbard_projector_extension_v6','hubbard_projector_extension_v7','hubbard_projector_extension_v8','hubbard_projector_extension_v9','hubbard_projector_extension_v10','hubbard_projector_extension_v11')
    telescope={}
    if c.get('kind') in ('hubbard_projector_extension_v5','hubbard_projector_extension_v6','hubbard_projector_extension_v7','hubbard_projector_extension_v8','hubbard_projector_extension_v9','hubbard_projector_extension_v10','hubbard_projector_extension_v11'):
    ...
    for key,(_,matrix,columns) in data.items():
        ...
        base=[[x+(gamma*hopping_matrix[i][j] if coherent else 0)+((corrections[i]-lower)*norms[i] if i==j else 0) for j,x in enumerate(row)] for i,row in enumerate(matrix)]
