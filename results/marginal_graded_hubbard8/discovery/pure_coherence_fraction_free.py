"""Bounded fraction-free exact solve for the 200-row discovery family."""
...
def solve(matrix,rhs):
    ...
    if not 1<=n<=m<=200 or len(matrix)!=m or any(len(row)!=n for row in matrix):
        raise ValueError('Bounded rectangular200-row system required')
