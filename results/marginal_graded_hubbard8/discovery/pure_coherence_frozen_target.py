...
def minimum(c):
    ...
    for key,fn in [('spin_telescope',spin_actions),('spectator_hopping',spectator_actions),('pair_transfer',pair_actions),('two_spectator_hopping',two_actions),('three_spectator_hopping',three_actions),('coherent_projector',coherent_actions),('pure_coherence',pure_actions)]:
