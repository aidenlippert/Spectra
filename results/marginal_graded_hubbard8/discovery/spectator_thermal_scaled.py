...
def main():
    ...
    for tau in (1e-6,1e-7):
        ...
        try:
            ...
            bounds=[((lo-z)/scale,(hi-z)/scale) for (lo,hi),z,scale in zip([(0,2.5)]*2+[(0,3)]*2+[(-2,2)]*80,origin,scales)]
