...
def main():
    ...
    for iteration in range(args.pricing_rounds):
        ...
        bounds[117]=(bounds[117][0],min(0,bounds[117][1]));bounds[118]=(bounds[118][0],min(0,bounds[118][1]))
        ...
        if candidate_violation>2e-8 or max(dual[117:])>1e-10:raise ValueError('Numerical trust LP feasibility check failed')
        center=dual.copy()
