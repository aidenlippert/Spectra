...
def main():
    ...
    result=linprog(energies,A_eq=arr[:196],b_eq=np.array(rhs[:196],float),A_ub=arr[196:],b_ub=np.array(rhs[196:],float),bounds=(0,None),method='highs',options={'dual_feasibility_tolerance':1e-10,'primal_feasibility_tolerance':1e-10})
    pricing=[]
