"""Bounded fraction-free exact solve for the 139-row discovery family."""
...
def solve(matrix,rhs):
    ...
    if not 1<=n<=m<=139 or len(matrix)!=m or any(len(row)!=n for row in matrix):
        raise ValueError('Bounded rectangular139-row system required')
