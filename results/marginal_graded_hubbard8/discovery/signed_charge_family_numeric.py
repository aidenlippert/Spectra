...
def main():
    parser=argparse.ArgumentParser();parser.add_argument('directory',type=Path);parser.add_argument('--scale',type=float,default=.02);parser.add_argument('--determinant-anchors',action='store_true');args=parser.parse_args();out=args.directory
    ...
    def anchor(s):
        ...
        return [F(1),F(0),F(0)]+t+[ph,q],energy
