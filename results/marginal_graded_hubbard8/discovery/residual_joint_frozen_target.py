...
from experiments.marginal_pure_coherence import actions as pure_actions
from experiments.marginal_residual_coherence import actions as residual_actions
...
def minimum(c):
    ...
    for key,fn in [('spin_telescope',spin_actions),('spectator_hopping',spectator_actions),('pair_transfer',pair_actions),('two_spectator_hopping',two_actions),('three_spectator_hopping',three_actions),('coherent_projector',coherent_actions),('pure_coherence',pure_actions),('residual_coherence',residual_actions)]:
