...
def main():
    ...
    result={'accepted':True,'full_spin_word_overlap_exactly_zero':True,'spin_word_zero_moments':120,
    ...
    (directory/'spin_word_closure.json').write_text(json.dumps(result,indent=2)+'\n')
