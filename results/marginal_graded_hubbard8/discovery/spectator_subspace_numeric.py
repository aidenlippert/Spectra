...
def main():
    ...
    def enrich(y):
        ...
        for e,key,v in spectra:
            ...
            n=int(sum(s>1e-8))
            if n>24:raise RuntimeError('subspace dimension cap24 reached')
            basis[key]=u[:,:n]
