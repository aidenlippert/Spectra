...
def main():
    ...
    if set(energy['target'])!={'U','t','V'} or any(F(energy['target'][k])!=v for k,v in [('U',F(4)),('t',F(1)),('V',F(1,2))]):
        raise ValueError('This fixed-family cap covers only nearest-neighbor U4,t1,V1/2')
