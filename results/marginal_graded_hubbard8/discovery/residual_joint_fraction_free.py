"""Bounded fraction-free exact solve for the 202-row discovery family."""
...
def solve(matrix,rhs):
    ...
    if not 1<=n<=m<=202 or len(matrix)!=m or any(len(row)!=n for row in matrix):
        raise ValueError('Bounded rectangular202-row system required')
