...
def main():
    parser=argparse.ArgumentParser();parser.add_argument('directory',type=Path);parser.add_argument('--scale',type=float,default=.002);parser.add_argument('--determinant-anchors',action='store_true');parser.add_argument('--pricing-rounds',type=int,default=0);parser.add_argument('--pricing-radius',type=float,default=0);parser.add_argument('--pricing-eigenvectors',type=int,choices=(1,2),default=1);args=parser.parse_args();out=args.directory
