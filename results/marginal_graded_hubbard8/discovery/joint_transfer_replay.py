...
def main():
    parser=argparse.ArgumentParser();parser.add_argument('certificate',type=Path);parser.add_argument('--psd-witnesses',type=Path);args=parser.parse_args()
    ...
    lower=replay(c,psd_witnesses=witnesses);print('exact lower accepted',flush=True)
