"""Bounded fraction-free exact solve for the 137-row discovery family."""
...
def solve(matrix,rhs):
    ...
    if not 1<=n<=m<=137 or len(matrix)!=m or any(len(row)!=n for row in matrix):
        raise ValueError('Bounded rectangular137-row system required')
