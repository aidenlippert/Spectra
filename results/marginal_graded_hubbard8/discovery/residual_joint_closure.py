...
def main():
    ...
    if len(r['family_replay']['residual_coherence_moments'])!=2 or any(map(F,r['family_replay']['residual_coherence_moments'].values())):raise ValueError('Incomplete residual-coherence closure')
    ...
    result={'accepted':True,'full_spin_word_overlap_exactly_zero':True,'spin_word_zero_moments':120,'pure_coherence_zero_moments':2,'residual_coherence_zero_moments':2,
    ...
    (directory/'residual_joint_closure.json').write_text(json.dumps(result,indent=2)+'\n')
