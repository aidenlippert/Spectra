...
def main():
    ...
    if source['kind'] not in ('joint_diagonal_range2_family_limit_proposal_v1','joint_diagonal_range2_free_profile_proposal_v1'):
        raise ValueError('Explicit range-two proposal required')
    free_profile=source['kind']=='joint_diagonal_range2_free_profile_proposal_v1'
    ...
    receipt = {'accepted': True, 'free_range_two_profile':free_profile, 'family_replay': result, 'accepted_periodic_lower': str(lower),
