...
def main():
    ...
    for row in cases:
        ...
        fresh=build(rational[:6],args.target_v,args.target_w);minimum=(float('inf'),None);max_difference=0.
        for key,A,deriv,P,Q,T in mats:
        ...
        if args.target_w is not None:
            ...
            result['local_window']['range_two_density_profile']=list(map(str,local_profile(6,args.target_w)))
