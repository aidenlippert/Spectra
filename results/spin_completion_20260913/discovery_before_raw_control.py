...
from research.spin_completion_20260913.core import frames, replay
...
class Model(PreviousModel):
    ...
    def solve(self, span, out, remaining, separate=False, solver_cap=40.):
        ...
        cert['kind'] = 'spin_completion_subspace_v1'
