"""Exact comparison of a full-spin dual ceiling with the old physical proof."""
...
from research.spin_subspace_20260913.full_dual import check
...
def run(results, out):
    ...
    result = {'full_spin_dual': dual, 'dual_sha256': hashlib.sha256(dual_path.read_bytes()).hexdigest(),
        ...
        'scope': 'Exact accuracy obstruction only for the complete defined spin-frame cone and its subspaces. The independent physical comparison proof is not a discovery input.'}
