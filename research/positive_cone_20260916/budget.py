"""Bounded local subprocess ledger for the positive-cone investigation."""
import argparse
...
if __name__=='__main__':
    ...
    budget.OUT=Path(__file__).resolve().parents[2]/'results/positive_cone_20260916/runs'
    cmd=a.command[1:] if a.command and a.command[0]=='--' else a.command
    raise SystemExit(budget.run(a.name,a.seconds,cmd))
