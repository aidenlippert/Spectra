...
No static candidate is proposed.  A plausible candidate would need to specify a
fixed small clique family and a closed-form split, then prove both exact
reconstruction and a bound at least as strong as the row-10 witness.  The
