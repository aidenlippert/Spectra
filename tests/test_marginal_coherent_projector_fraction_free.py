...
from coherent_projector_fraction_free import solve
...
def test_full_row_bound_and_rational_column_scalings():
    matrix=[[F(1,3),F(2,5)],[1,-1]]+[[F(1,3),F(2,5)]]*137
    assert solve(matrix,[1,0]+[1]*137)==[F(15,11),F(15,11)]
...
def test_inconsistent_dependent_and_over_budget_systems_are_refused():
    ...
    with pytest.raises(ValueError,match='139-row'):solve([[1]]*140,[1]*140)
